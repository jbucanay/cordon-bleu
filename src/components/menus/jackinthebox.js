        ...
        return (
            <div>
                <div className="menu-items-upper">
                    ...
                    <h3 className="gray-tag">Open Hours: 10:00AM - 9:30AM</h3>
                    <div class="rating">
                    ...
                    <div className="info-part">
                        ...
                        <div className="seperate-part"> <div className="top">14-24</div><div className="bottom">minutes</div></div>
                        <div className="seperate-part"> <div className="top">0.6</div><div className="bottom">miles</div></div>
                    </div>
