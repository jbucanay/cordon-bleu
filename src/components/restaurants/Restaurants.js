  ...
  return (
    <article>
      ...
      <section className="featured">
        <div>
          <h1 className="featured-partners">Featured National Partners</h1>
        ...
        <div className="promoted">
          ...
          <div className="bottom">
            ...
            <figure>
              <Link to="/burgerking">
                <img
                  src="https://media.licdn.com/dms/image/C4D1BAQHTMNOwn3bL6Q/company-background_10000/0?e=2159024400&v=beta&t=VEG52jfelrD-keOBGYqNSqdI8mYqEknDivUJLLyNUyY"
                  alt="burgerking"
                  width="210"
                  height="100"
                />
      ...
      <section className="pickup">
        <header>
          <h1 className="featured-partners">New! Try Pickup</h1>
